export type ResumeExperience = {
    ...
    period: string;
    bullets: string[];
    /** @deprecated kept for backward compat with old parsed data */
    description?: string;
};
...
export const resumeProfile = {
    ...
    github: "github.com/MustafaAljumayli",
...
export const resumeExperience: ResumeExperience[] = [
    {
        ...
        bullets: ["Graduate Researcher at Georgia Tech in Applied AI/ML research."],
    },
    {
        title: "Software Engineer, Analyst",
        company: "Deutsche Bank",
        period: "July 2025 - Present",
        bullets: ["Development for the Investment Banking Research Technology team."],
    },
    {
        ...
        bullets: [
            ...
            "Developed on the OtoSight device: a device that captures and analyzes infection in the ear canal.",
        ],
    },
    {
        ...
        bullets: ["Provided development support for the UNC college of arts and sciences."],
    },
    {
        title: "Data Warehouse Analyst",
        company: "UNC School of Government",
        period: "May 2024 - July 2024",
        bullets: ["Created data pipelines for the UNC School of Government."],
    },
    {
        title: "Data Visualization Analyst",
        company: "BeAM UNC",
        period: "March 2024 - June 2024",
        bullets: ["Created data visualizations for the UNC Chapel Hill OASIS and BeAM Makerspace."],
    },
    {
        title: "IT Support Technician / Student IT Team Lead",
        company: "University of North Carolina at Chapel Hill",
        period: "August 2023 - July 2024",
        bullets: ["Provided IT support for the college of arts and sciences."],
    },
    {
        title: "Founder",
        company: "FetchTek",
        ...
        bullets: [
            "Created a B2B business that provided IT asset liquidation for companies.",
            "Grew into the largest electronic distributor in the RDU region ~ $7M in revenue.",
        ],
    },
    {
        title: "Realtor",
        ...
        bullets: ["Helped clients buy and sell homes."],
    },
    {
        title: "Realtor",
    ...
    },
    {
        ...
        bullets: ["Helped customers find products and complete transactions."],
    },
];
